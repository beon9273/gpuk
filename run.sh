...
./INSTALL/bin/KalmanFitterCPUTest -a Intel_Xeon_Gold_6230R -t 1000 --smoothing 1 -o 1 >> result/KalmanFitter_Step_Result/track1000_smoothing.log
./INSTALL/bin/KalmanFitterCPUTest -a Intel_Xeon_Gold_6230R -t 1000 --smoothing 0 -o 0 >> result/KalmanFitter_Step_Result/track1000_no_smoothing.log
